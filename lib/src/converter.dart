...
String convertImage(FileSystemEntity selectedFile, String format) {
  ...
  final newPath = replaceExtention(selectedFile.path, format);
  new File(newPath).writeAsBytesSync(newImage);
  return newPath;
}

String replaceExtention(String path, String newExtention) {
  return path.replaceAll(new RegExp(r'(png|jpg|jpeg)'), newExtention);
}
